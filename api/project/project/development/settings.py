...
EMAIL_BACKEND = 'project.development.ses_backend.SESBackend'
...
AWS_STORAGE_BUCKET_NAME = os.environ.get(
    "AWS_S3_BUCKET", default='development-genie')
...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'api-dev-genie.ap-south-1.elasticbeanstalk.com'
]
...
ROOT_URLCONF = 'project.development.urls'
...
ASGI_APPLICATION = 'project.development.asgi.application'
# WSGI_APPLICATION = 'project.development.wsgi.application'
